...
local SpawnsSection = SellSection.NewSection("Rare Item Spawns")
local OresSection = SellSection.NewSection("Ore Spawns")
local ChestsSection = SellSection.NewSection("Chest Spawns")
--//labels
